# Homeworld names
@at 0x80010000
const level_title_dragonx       = "DRAGON X"        # Unused in game. May not be a level title, could be a placeholder name for a dragon name.
@at 0x8001000c
const level_title_thigh_masters = "THIGH MASTERS"   # Unused in game
@at 0x8001001c
const level_title_gnastys_world = "GNASTY'S WORLD"
@at 0x8001002c
const level_title_dream_weavers = "DREAM WEAVERS"
@at 0x8001003c
const level_title_beast_makers  = "BEAST MAKERS"
@at 0x8001004c
...
#@at 0x80075568
#const level_name_jacques       = "JACQUES" # Located in different place in memory for some reason
@at 0x800100dc
...
#@at 0x80075570
#const level_name_toasty      = "TOASTY" # Located in different place in memory for some reason
@at 0x800101e4
