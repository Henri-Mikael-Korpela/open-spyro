...
addr LEVEL_TRANSITION_HOME
addr LEVEL_NAME_DRY_CANYON
addr LEVEL_NAME_CLIFF_TOWN
addr LEVEL_NAME_ICE_CAVERN
addr LEVEL_NAME_DOCTOR_SHEMP
addr LEVEL_NAME_NIGHT_FLIGHT

addr LEVEL_TRANSITION_HOME
addr LEVEL_NAME_ALPINE_RIDGE
addr LEVEL_NAME_HIGH_CAVES
addr LEVEL_NAME_WIZARD_PEAK
addr LEVEL_NAME_BLOWHARD
addr LEVEL_NAME_CRYSTAL_FLIGHT

addr LEVEL_TRANSITION_HOME
addr LEVEL_NAME_TERRACE_VILLAGE
addr LEVEL_NAME_MISTY_BOG
addr LEVEL_NAME_TREE_TOPS
addr LEVEL_NAME_METALHEAD
addr LEVEL_NAME_WILD_FLIGHT

addr LEVEL_TRANSITION_HOME
addr LEVEL_NAME_DARK_PASSAGE
addr LEVEL_NAME_LOFTY_CASTLE
addr LEVEL_NAME_HAUNTED_TOWERS
#addr LEVEL_NAME_JACQUES
@at 0x8006f864
addr LEVEL_NAME_ICY_FLIGHT

addr LEVEL_NAME_GNORC_GNEXUS
addr LEVEL_NAME_GNORC_COVE
addr LEVEL_NAME_TWILIGHT_HARBOR
addr LEVEL_NAME_GNASTY_GNORC
addr LEVEL_NAME_GNASTYS_LOOT

@at 0x8006f880
addr INFO_RETURN_HOME
